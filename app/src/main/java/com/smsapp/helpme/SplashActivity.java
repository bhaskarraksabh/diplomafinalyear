...
public class SplashActivity extends AwesomeSplash {
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        //Customize Title
        configSplash.setTitleSplash("HelpMe");
    ...
    public void animationsFinished() {
        ...
        Intent stopRingActivity = new Intent(getApplicationContext(), MainActivity.class);
        stopRingActivity.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        getApplicationContext().startActivity(stopRingActivity);
    }
}
